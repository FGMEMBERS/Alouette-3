...
aircraft.light.new("sim/model/alouette3/lighting/strobe-top", [0.05, 1.00], strobe_switch);
aircraft.light.new("sim/model/alouette3/lighting/strobe-bottom", [0.05, 1.03], strobe_switch);

# beacons ===========================================================
var beacon_switch = props.globals.getNode("controls/lighting/beacon", 1);
aircraft.light.new("sim/model/alouette3/lighting/beacon-top", [0.62, 0.62], beacon_switch);
aircraft.light.new("sim/model/alouette3/lighting/beacon-bottom", [0.63, 0.63], beacon_switch);
...
var nav_lights = props.globals.getNode("sim/model/alouette3/lighting/nav-lights", 1);
...
# engines/rotor =====================================================
var state = props.globals.getNode("sim/model/alouette3/state");
var is_inside_view = props.globals.getNode("sim/model/alouette3/is_inside_view");
var is_outside_view = props.globals.getNode("sim/model/alouette3/is_outside_view");
var engine = props.globals.getNode("sim/model/alouette3/engine");
...
var turbine = props.globals.getNode("sim/model/alouette3/turbine-rpm-pct", 1);
var torque_pct = props.globals.getNode("sim/model/alouette3/torque-pct", 1);
...
var rotor_step = props.globals.getNode("sim/model/alouette3/rotor-step-deg");
